...
\hypersetup{
    ...
    pdfsubject={Explainable AI, NLP},
    pdfkeywords={Artificial intelligence, Model complexity, Nlp architectures, Statistical correlation, Transformer models}
}

\geometry{margin=2.5cm}
\onehalfspacing

\title{Examining the Balance: An in-depth meta-analysis of explainability versus performance in natural language processing models.}
...
The repository follows computational reproducibility standards with explicit dependency specifications (Python 3.9, pandas, scipy, statsmodels, matplotlib, seaborn) and step-by-step execution instructions. All analyses can be regenerated from raw data to final figures with a single command execution. The code is available at https://github.com/kjmezui/xai-manuscript.
